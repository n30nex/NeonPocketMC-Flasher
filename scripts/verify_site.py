...
def main() -> int:
    ...
    require(deskos["tag"] == "v1.8.0-rc.6", "wrong DeskOS release")
    require(deskos["commit"] == "4c9293b5925c08bc9609242dfe986d20446036ed", "wrong DeskOS commit")
    ...
    require(deskos_profile["update"]["sha256"] == "fd67cbcc8344e3ae6de9800071fcb6a30ce6099d74d961996d30925944f05573", "wrong DeskOS app")
