...
def main() -> int:
    ...
    require(deskos["tag"] == "v1.8.0-rc.4", "wrong DeskOS release")
    require(deskos["commit"] == "220d309bfbec05b2324dbf184fbfcfb28ad55a8d", "wrong DeskOS commit")
    ...
    require(deskos_profile["update"]["sha256"] == "56a726d060ca2838861092fd37f6de7b3cb2dbc278d418cfffbb48886f96dfb5", "wrong DeskOS app")
