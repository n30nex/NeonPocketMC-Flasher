...
def main() -> int:
    ...
    require("flasher.js?v=20260821devices1" in html, "flasher JS cache bust is stale")
    require("flasher.css?v=20260821devices1" in html, "flasher CSS cache bust is stale")
    require((ROOT / "assets" / "visuals" / "flasher-hero.webp").is_file(), "missing flasher hero")
